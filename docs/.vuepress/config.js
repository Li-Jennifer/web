...
module.exports = {
  ...
  themeConfig: {
    ...
    author: {
      ...
      name: "Jennifer", // 必需
      href: "https://github.com/leefaith", // 可选的
    },
    blogger: {
      // 博主信息，显示在首页侧边栏
      avatar: "/img/logo.jpg",
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          ...
          title: "GitHub",
          link: "https://github.com/leefaith",
        },
        {
          iconClass: "icon-erji",
          title: "听音乐",
    ...
    footer: {
      ...
      copyrightInfo:
        'Jennifer | <a href="https://github.com/leefaith" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    },
  },
  plugins: [
    // 插件
